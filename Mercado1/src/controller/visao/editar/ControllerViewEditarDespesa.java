...
public class ControllerViewEditarDespesa extends ControllerViewEditar {
    ...
    protected void save() {
        ...
        if (this.checkParameters(sDescricao, sValor) == true) {
            ...
            new DaoOperacao().insert(new Operacao("Despesa = " + oDespesa.getId(), new DaoAcao().get(14L), this.viewEditarDespesa.getUsuario()));
            new ViewMensagem(this.viewEditarDespesa, "Despesa Atualizada com Sucesso!").setVisible(true);
