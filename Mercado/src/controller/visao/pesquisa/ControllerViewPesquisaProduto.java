...
public class ControllerViewPesquisaProduto extends ControllerViewModal {
    ...
    protected void select() {
        ...
        if ((iIndex >= 0) 
            ...
            }else if (this.viewPesquisaProduto.getParent() instanceof ViewOperacaoGerenciarProduto) {
                ((ViewOperacaoGerenciarProduto) this.viewPesquisaProduto.getViewParent()).setProduto(this.produtos.get(iIndex));
            }
            this.viewPesquisaProduto.dispose();
        }else {
