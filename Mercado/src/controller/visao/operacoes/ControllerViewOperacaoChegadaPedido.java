...
import visao.ajuda.ViewAjudaChegadaPedido;
...
public class ControllerViewOperacaoChegadaPedido extends ControllerViewModal {
    ...
    public void actionPerformed(ActionEvent oActionEvent) {
        ...
        }else if (oActionEvent.getSource().equals(this.viewOperacaoChegadaPedido.getButtonAjuda())) {
            new ViewAjudaChegadaPedido(this.viewOperacaoChegadaPedido).setVisible(true);
        }
    }
}