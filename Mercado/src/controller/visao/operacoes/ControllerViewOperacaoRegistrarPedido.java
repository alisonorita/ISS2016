...
import visao.ajuda.ViewAjudaRegistrarPedido;
...
public class ControllerViewOperacaoRegistrarPedido extends ControllerViewModal {
    ...
    public boolean checkParameters(Fornecedor oFornecedor, List<ItemPedido> oItensPedido, String sData) {
        if (oFornecedor == null) {
    ...
    public void actionPerformed(ActionEvent oActionEvent) {
        if (oActionEvent.getSource().equals(this.viewOperacaoRegistrarPedido.getButtonSearchFornecedor())) {
            ...
            if (this.checkParameters(oFornecedor, oItensPedido, sDataPagamento) == true) {
                ...
                new DaoOperacao().insert(new Operacao("Pedido = " + oPedido.getId(), new DaoAcao().get(28L), this.viewOperacaoRegistrarPedido.getUsuario()));
