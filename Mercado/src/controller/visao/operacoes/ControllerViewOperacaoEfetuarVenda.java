...
import visao.ajuda.ViewAjudaEfetuarVenda;
...
public class ControllerViewOperacaoEfetuarVenda extends ControllerViewModal {
    ...
    public void actionPerformed(ActionEvent oActionEvent) {
        ...
        }else if (oActionEvent.getSource().equals(this.viewOperacaoEfetuarVenda.getButtonAjuda())) {
            new ViewAjudaEfetuarVenda(this.viewOperacaoEfetuarVenda).setVisible(true);
        }
    }
    
    public boolean checkParameters(Cliente oCliente, List<ItemVenda> oItens) {
        if (oCliente == null) {
