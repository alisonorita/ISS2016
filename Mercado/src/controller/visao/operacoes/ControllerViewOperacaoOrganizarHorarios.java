...
import visao.ajuda.ViewAjudaOrganizarHorario;
...
public class ControllerViewOperacaoOrganizarHorarios extends ControllerViewModal {
    ...
    public void actionPerformed(ActionEvent oActionEvent) {
        if (oActionEvent.getSource().equals(this.viewOperacaoOrganizarHorarios.getButtonSearch())) {
            ...
            this.viewOperacaoOrganizarHorarios.dispose();
        }else if (oActionEvent.getSource().equals(this.viewOperacaoOrganizarHorarios.getButtonAjuda())) {
            new ViewAjudaOrganizarHorario(this.viewOperacaoOrganizarHorarios).setVisible(true);
        }
    }    
}